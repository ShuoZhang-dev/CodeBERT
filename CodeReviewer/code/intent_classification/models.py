...
def build_or_load_gen_model(args):
    assert args.model_type.lower() in ["codet5", "t5", "scratch"] 
    ...
    config.num_cls = args.num_cls
    # need to change this is model_class is not ReviewerModel
    model = model_class.from_pretrained(args.model_name_or_path, args.num_cls)
